...
public class FirstHeadView extends View {
    ...
    public FirstHeadView(Context context, AttributeSet attrs,
                                       int defStyle) {
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        //Log.e(getClass().getSimpleName(), "onMeasure()  widthMeasureSpec = "
        //    + (widthMeasureSpec & MEASURED_SIZE_MASK)
        //    + "   heightMeasureSpec = "
        //    + (heightMeasureSpec & MEASURED_SIZE_MASK));
        ...
        //Log.e(getClass().getSimpleName(), "onMeasure()  measuredWidth = "
        //    + (widthMeasureSpec & MEASURED_SIZE_MASK)
        //    + "   measuredHeight = "
        //    + (heightMeasureSpec & MEASURED_SIZE_MASK));
    ...
    private int measureWidth(int widMeasureSpec){
        ...
        //Log.e(getClass().getSimpleName(), "measureWidth()  size = " + size);
    ...
    private static final int ZEARO = 0;
    ...
    protected void onDraw(Canvas canvas) {
        ...
        canvas.scale(mCurrentProgress, mCurrentProgress, measuredWidth/TWO, measuredHeight/TWO);
        //将等比例缩放后的椭圆形画在画布上面
        canvas.drawBitmap(scaledBitmap,ZEARO,measuredHeight/FOUR,null);
    }
